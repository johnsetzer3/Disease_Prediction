...
## Machine Learning
SciKitLearn is the ML library we'll be using to create a classifier. Our training and testing setup is Logistical Regression. We will also incorportate Random Forest to make predictions using our testing data. 
